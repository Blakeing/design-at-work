...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    {""}
    <ChevronDown
      className="relative top-[1px] ml-1 h-3 w-3 transition-transform duration-[250] ease-in group-data-[state=open]:-rotate-180"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
));
...
>(({ className, ...props }, ref) => (
  <div
    className={cn(
      "absolute perspective-[2000px] left-0 top-full flex justify-center"
    )}
  >
    <NavigationMenuPrimitive.Viewport
      ...
      // )}
      className={cn(
        "data-[state=open]:animate-scaleIn data-[state=closed]:animate-scaleOut relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-[top_center] overflow-hidden  rounded-md border border-neutral-200  text-neutral-950 shadow-lg bg-white transition-[width,_height] duration-300 sm:w-[var(--radix-navigation-menu-viewport-width)] dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50",
        className
      )}
      ref={ref}
      {...props}
